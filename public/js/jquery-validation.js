...
$.extend($.validator, {
	...
	messages: {
		...
		dateLessEqThan: $.validator.format("Please enter a Date less than or equal to {0}."),
		...
		youtubeUrl: "Por favor ingrese un link de youtube v&aacute;lido."
	},
	...
	methods: {
        ...
        dateMoreEqThan: function(value, element, param) {
			value=parseDate(value);
			param=parseDate(param);
			return value >= param;
		},
		...
		youtubeUrl: function(value, element) {
			return this.optional(element) || /(http:\/\/)?(?:www\.)?(((youtube\.)(com)(\/watch\?v=))|((youtu\.)(be\/)))([a-zA-Z0-9_-]+)(\&feature=)?([a-zA-Z0-9_-]+)?/.test(value);
		}	
