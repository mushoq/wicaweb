...
DROP SCHEMA IF EXISTS `wicaweb` ;
CREATE SCHEMA IF NOT EXISTS `wicaweb` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;
USE `wicaweb` ;

-- -----------------------------------------------------
-- Table `wicaweb`.`wc_website_template`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_website_template` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_website_template` (
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_website_language`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_website_language` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_website_language` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_website`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_website` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_website` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_website_template1`
    ...
    REFERENCES `wicaweb`.`wc_website_template` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_website_language1`
    FOREIGN KEY (`language_id` )
    REFERENCES `wicaweb`.`wc_website_language` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_area`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_area` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_area` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_template`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_template` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_template` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(200) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section` (
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_type` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_type` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(100) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_content_content_type1`
    ...
    REFERENCES `wicaweb`.`wc_content_type` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_field`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_field` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_field` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `content_type_id` INT NOT NULL ,
  `name` VARCHAR(100) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_field`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_field` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_field` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_content_field_field1`
    ...
    REFERENCES `wicaweb`.`wc_field` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_content_field_content1`
    FOREIGN KEY (`content_id` )
    REFERENCES `wicaweb`.`wc_content` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `wicaweb`.`forum`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`forum` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`forum` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(200) NOT NULL ,
  `topic` TEXT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`forum_comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`forum_comment` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`forum_comment` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- Table `wicaweb`.`poll`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`poll` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`poll` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`question` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`question` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`answer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`answer` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`answer` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_answer_question1`
    ...
    REFERENCES `wicaweb`.`question` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wicaweb`.`banner`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`banner` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`banner` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`banner_counts`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`banner_counts` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`banner_counts` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_module`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_module` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_module` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(45) NOT NULL ,
  `description` TEXT NULL ,
  `status` ENUM('active', 'inactive') NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_module_description`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_module_description` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_module_description` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_module_description_module1`
    ...
    REFERENCES `wicaweb`.`wc_module` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_module_area`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_module_area` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_module_area` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_module_action`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_module_action` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_module_action` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `module_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_prints`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_prints` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_prints` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `section_id` BIGINT NOT NULL ,
  `count` BIGINT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_public_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_public_user` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_public_user` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_dictionary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_dictionary` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_dictionary` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `website_id` INT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_word`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_word` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_word` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_word_dictionary1`
    ...
    REFERENCES `wicaweb`.`wc_dictionary` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_profile` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_profile` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(100) NOT NULL ,
  `status` ENUM('active', 'inactive') NOT NULL ,
  PRIMARY KEY (`id`) )
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_user` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_user` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_wc_user_wc_profile1`
    ...
    REFERENCES `wicaweb`.`wc_profile` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_log` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_log` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(100) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_module_action_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_module_action_profile` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_module_action_profile` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `profile_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_module_action_profile_module_action1`
    ...
    REFERENCES `wicaweb`.`wc_module_action` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_profile` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_profile` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `profile_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_website_profile`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_website_profile` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_website_profile` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `profile_id` INT NOT NULL ,
  `website_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_temp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_temp` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_temp` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `content_type_id` INT NOT NULL ,
  `content_id` INT NULL ,
  `website_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_field_temp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_field_temp` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_field_temp` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `field_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_wc_content_field_temp_wc_content_temp1`
    ...
    REFERENCES `wicaweb`.`wc_content_temp` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_website_state`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_website_state` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_website_state` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `website_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`product` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`product` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_image` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_image` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `section_id` BIGINT NOT NULL ,
  `name` VARCHAR(100) NULL ,
  `file_name` VARCHAR(100) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_comment` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_comment` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `section_id` BIGINT NOT NULL ,
  `content` TEXT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_temp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_temp` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_temp` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
  `section_id` BIGINT NULL ,
  `section_parent_id` BIGINT NULL ,
  `website_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_storage` (
  `id` BIGINT NOT NULL ,
  `section_parent_id` BIGINT NULL ,
  `website_id` INT NOT NULL ,
  `section_template_id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_wc_section_storage_wc_section_storage1`
    FOREIGN KEY (`section_parent_id` )
    REFERENCES `wicaweb`.`wc_section_storage` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_module_area_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_module_area_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_module_area_storage` (
  `id` INT NOT NULL ,
  `section_id` BIGINT NOT NULL ,
  `area_id` INT NOT NULL ,
  `module_description_id` INT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_storage` (
  `id` INT NOT NULL ,
  `content_type_id` INT NOT NULL ,
  `website_id` INT NOT NULL ,
  `internal_name` VARCHAR(200) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_field_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_field_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_field_storage` (
  `id` INT NOT NULL ,
  `field_id` INT NOT NULL ,
  `content_id` INT NOT NULL ,
  `value` TEXT NULL ,
  ...
  CONSTRAINT `fk_content_field_store_content_store1`
    FOREIGN KEY (`content_id` )
    REFERENCES `wicaweb`.`wc_content_storage` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_image_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_image_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_image_storage` (
  `id` INT NOT NULL ,
  `section_id` BIGINT NOT NULL ,
  `name` VARCHAR(100) NULL ,
  `file_name` VARCHAR(100) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_comment_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_comment_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_comment_storage` (
  `id` INT NOT NULL ,
  `section_id` BIGINT NOT NULL ,
  `content` TEXT NOT NULL ,
  `author_id` VARCHAR(45) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_prints_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_prints_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_prints_storage` (
  `id` INT NOT NULL ,
  `section_id` BIGINT NOT NULL ,
  `count` BIGINT NULL ,
  PRIMARY KEY (`id`, `section_id`) ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_menu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_menu` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_menu` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(100) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_menu_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_menu_item` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_menu_item` (
  `id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_form_field`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_form_field` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_form_field` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `content_id` INT NOT NULL ,
  `name` VARCHAR(100) NOT NULL ,
  `description` VARCHAR(250) NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_form_field_temp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_form_field_temp` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_form_field_temp` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `content_temp_id` INT NOT NULL ,
  `name` VARCHAR(100) NOT NULL ,
  `description` VARCHAR(250) NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_form_field_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_form_field_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_form_field_storage` (
  `id` INT NOT NULL ,
  `content_id` INT NOT NULL ,
  `name` VARCHAR(100) NOT NULL ,
  `description` VARCHAR(250) NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_image_temp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_image_temp` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_image_temp` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  ...
  CONSTRAINT `fk_wc_section_image_temp_wc_section_temp1`
    ...
    REFERENCES `wicaweb`.`wc_section_temp` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_by_section`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_by_section` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_by_section` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
  `section_id` BIGINT NOT NULL ,
  `content_id` INT NOT NULL ,
  `weight` INT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_by_section_temp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_by_section_temp` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_by_section_temp` (
  `id` BIGINT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_content_by_section_storage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_content_by_section_storage` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_content_by_section_storage` (
  `id` BIGINT NOT NULL ,
  `section_id` BIGINT NOT NULL ,
  `content_id` INT NOT NULL ,
  `weight` INT NULL ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_external_files`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_external_files` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_external_files` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `website_id` INT NULL ,
  ...
  `order_number` INT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_wc_external_files_wc_website1_idx` (`website_id` ASC) ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`wc_section_module_area_temp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`wc_section_module_area_temp` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`wc_section_module_area_temp` (
  `id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `wicaweb`.`product_catalog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wicaweb`.`product_catalog` ;

CREATE  TABLE IF NOT EXISTS `wicaweb`.`product_catalog` (
  `id` INT NOT NULL AUTO_INCREMENT ,
