...
//                	required: true
	...
	$('[id^=section_storage_]').each(function(){	
		$(this).bind('click',function(){
			...
			if($("#section_storage").val()=='yes'){
				$("#section_expiration_time_container").show();
	...
	$('[id^=section_expiration_]').each(function(){	
		$(this).bind('click',function(){
			...
			if($("#section_expiration").val()=='yes'){
				$("#section_storage_container").show();
	...
	$('[id^=section_comments_management_]').each(function(){
		...
		$(this).bind('click',function(){
			...
			if($(this).attr('option') == 'yes'){
				$('#section_comments_type_container').show();
				$('#section_comments_container').show();
	...
	$('#section_images_number').val(0); //default value
	...
	//sitemap levels
	$('#sitemap_level').val(1); //default value
...
function setWatermarkPos(){
	...
	setTimeout("setPosition($('#watermark_pos').val())",50);
